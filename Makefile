.PHONY: dev dev-api dev-stop dev-stop-api dev-restart test test-unit test-fast test-cov lint typecheck fmt check clean db-up db-down db-migrate db-reset logs logs-api status help
...
dev-stop: dev-stop-api

dev-restart: dev-stop dev-api
