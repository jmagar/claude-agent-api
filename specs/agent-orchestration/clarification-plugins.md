...
[0.83] https://docs.openclaw.ai/gateway/security — [​](https://docs.openclaw.ai/gateway/security#what-the-audit-checks-high-level)
  Details: [Plugins](https://docs.openclaw.ai/plugin)

[0.81] https://docs.openclaw.ai/tools
  *   [Plugins + tools](https://docs.openclaw.ai/tools#plugins-%2B-tools)

[0.79] https://docs.openclaw.ai/tools
