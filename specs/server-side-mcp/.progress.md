...
- [x] 2.3 [RED] Write failing tests for env var resolution - TBD

## Current Task

Task 2.3 complete (RED phase). Tests written and passing (implementation existed from Phase 1). Ready for task 2.4.
...
Task 2.3: RED phase - write failing tests for env var resolution
