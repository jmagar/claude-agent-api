...
- [x] 3.4 Write integration test for opt-out mechanism - TBD

## Current Task

Task 3.5: Write integration test for multi-tenant isolation
...
Task 3.3: Write integration test for request override
