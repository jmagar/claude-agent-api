...
Task 2.20 complete. ConfigValidator integrated into McpConfigInjector - adds optional validator dependency, sanitizes merged config before logging. All 4 injector tests now PASS. GREEN phase complete.
...
Task 2.21: [REFACTOR] Add error handling to injector
